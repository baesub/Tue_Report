...
Figma를 처음 사용하기에 알아가기위한 목적으로 Figma에 대해 조사해보며 소개하는 웹사이트 디자인을 Figma를 이용하여 제작해보았습니다.
...
('피그마를 선택한 전문가들의 의견' 부분은 Figma에서 코드로 변환할 때 무한 로딩이되어 <br> 
html 파일에는 추가하지 못했습니다. 대신에 Zeplin으로 접속하면 확인하실 수 있습니다!)
